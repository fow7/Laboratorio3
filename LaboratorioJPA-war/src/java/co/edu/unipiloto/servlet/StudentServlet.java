...
public class StudentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int id = Integer.valueOf(request.getParameter("studentId"));
            String nombre = request.getParameter("firstName");
            String apellido = request.getParameter("lastName");
            int anho = Integer.valueOf(request.getParameter("yearLevel"));
            
            Student student = new Student(id, nombre,apellido,anho);
            ...
            if(accion.equals("Add")){
                ...
                if(accion.equals("Edit")){
                    ...
                    student = studentFacade.find(student.getStudentid());
                    }                    
